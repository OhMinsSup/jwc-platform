...
import { useIsMobile } from "@jwc/ui/components/hooks/use-mobile";
...
import { Sheet, SheetContent } from "@jwc/ui/components/shadcn/sheet";
...
import {
	...
	TooltipProvider,
	TooltipTrigger,
} from "@jwc/ui/components/shadcn/tooltip";
...
function SidebarProvider({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: setOpenMobile is stable dispatch function
...
function SidebarMenuSubItem({ ref, ...props }: React.ComponentProps<"li">) {
	return <li data-slot="sidebar-menu-sub-item" ref={ref} {...props} />;
}
